package com.example.elam.android11_4;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        empFirstName = new String[]{"navin", "selvarani", "narmadha", "balakrishnan", "navinar"};
        empLastName = new String[]{"balakrishnan","balakrishnan","balakrishnan","selvarani","bala"};
